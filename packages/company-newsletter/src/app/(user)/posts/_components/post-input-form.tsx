...
export function PostInputForm(props: UserInputFormProps) {
	...
	const form = useForm({
		...
		onSubmit: async (params, setErrorMessage) => {
			...
			let actionResult: Result<unknown>;
			if (props.post) {
	...
	return (
		<Form {...form} submitButtonLabel="投稿する">
			...
			<div>
				{/* biome-ignore lint/a11y/noLabelWithoutControl: 複数の入力コントロールに対する見出し的なラベル */}
				...
				<div className="flex flex-col gap-1">
					...
					{attachments.map((attachment, i) => {
						return (
							// biome-ignore lint/suspicious/noArrayIndexKey: 添付ファイルには一意のIDがないためインデックスを使用
